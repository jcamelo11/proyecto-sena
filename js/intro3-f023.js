function intro_calcular() {
    ...
    intro.setOptions({
        steps: [
            ...
            {
                element: document.getElementById(''),
                intro: '<strong>Informe F023 Final</strong><br><br><audio autoplay class="w-100 mt-3" style="display: none;" controls><source src="audios/f023-03/final.m4a" type="audio/mpeg"></audio>Indicaciones de como diligenciar',
                step: 0,
                position: 'right',
                x: 100, // Coordenada X
                y: 0, // Coordenada Y
